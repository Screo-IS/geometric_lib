...
- def perimeter(r) - функция принимает на вход два числовых значения a и b, а потом при помощи формулы P = 2*a + 2*b находит и возвращает периметр прямоугольника.
